...
Uma vez definido o modelo probabilístico para intervenções e o efeito causal médio, podemos proceder com a inferência causal. Essa inferência geralmente envolve duas etapas fundamentais:

- **Identificação Causal:** Como expressar o efeito causal em termos da distribuição observacional dos dados?

- **Estimação:** Uma vez estabelecida essa relação, como calcular o efeito causal a partir dos dados disponíveis?
